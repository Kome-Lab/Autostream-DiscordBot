...
// for a supervisor to detect stuck handshakes (op26 sent but neither op29 nor
// op30 established an epoch) or partial-roster failures.
//
...
type DAVEHealth struct {
	...
	EpochEstablished    bool      // true once op29 commit or op30 welcome established an epoch
...
func (v *VoiceConnection) DAVEHealth() DAVEHealth {
	...
	return DAVEHealth{
		...
		EpochEstablished:    d.epochEstablished,
